...
class HttpClass(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        try:
            ...
            #print(numpy.array(acc.values[:, 1]),"\n\n", numpy.array(mag.values[:, 1]))
    ...
    def filter_data(self, data):
        ...
        filter_criteria = {
            'name': ['totalacceleration', 'gyroscopeuncalibrated','magnetometer'],  # Only include these sensor types
        }
    ...
    def calculate_orientation(self, acc_data, mag_data):
        ...
        # Apply complementary filter to combine accelerometer and magnetometer data
        #self.roll = alpha * self.roll + beta * roll_acc
        #self.pitch = alpha * self.pitch + beta * pitch_acc
